...
const SliderWrapper = ({ className, slidesPerView, image1, image2 }) => {
  const prevRef = useRef(null);
  const nextRef = useRef(null);

  return (
    <div className="text-white pt-12 md:pt-20 lg:pt-28.25 relative w-full">
      <div className="max-w-360 w-full mx-auto ">
        <div className="flex w-full px-4 xl:px-37 justify-between items-center mb-6 md:mb-7.5 ">
          <h2 className="text-2xl z-20 sm:text-3xl md:text-4xl lg:text-5xl font-medium font-poppins leading-118 -tracking-6">
            Category Name
          </h2>
