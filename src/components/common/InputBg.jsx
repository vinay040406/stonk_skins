...
const InputBg = () => {
  return (
    <button
      ...
      className="flex
     relative cursor-pointer transition-all h-13 px-5 lg:pr-5.25 lg:pl-8.5 items-center justify-between duration-300 hover:-translate-y-1 max-w-61.25 text-white mt-6 md:mt-10.25 font-dm-sans"
    >
      <span
